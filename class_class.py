...
def class_chose():
    time.sleep(2)
    driver.find_element_by_xpath('//*[@id="s-h-course-info"]/div[2]/div').click()
    time.sleep(2)
...
def time_getter():
    ...
    url_li = driver.find_elements_by_xpath('//*[contains(@class,"icon-wmv") or contains(@class,"icon-mkv")]')
